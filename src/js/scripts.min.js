...
var menu = document.querySelector('.js-menu'); // const phone = document.querySelector('.js-phone');
...
function open() {
  ...
  menu.classList.add('is-open'); // phone.classList.add('is-open');
...
function close() {
  ...
  menu.classList.remove('is-open'); // phone.classList.remove('is-open');
...
function init() {
  burger.addEventListener('click', toggle); // search.addEventListener('click', close);
}
...
},{"./burger-menu.js":93,"gsap":2}],95:[function(require,module,exports){
"use strict";
...
function init() {
  ...
  var sliderPartners = new _swiper.default(".partners__item--slider", {
    loop: true,
    slidesPerView: 5,
    spaceBetween: 100,
    effect: 'slide',
...
function init() {
  ...
  var slider = new _swiper.default(".slider__swiper", (_Swiper = {
    loop: true,
...
},{"swiper":92}],98:[function(require,module,exports){
"use strict";
...
var _slider = _interopRequireDefault(require("../libs/modules/slider.js"));

var _sliderPartners = _interopRequireDefault(require("../libs/modules/slider-partners.js"));

var _revealAjax = _interopRequireDefault(require("../libs/modules/reveal-ajax"));
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  _sliderPartners.default.init();

  _revealAjax.default.init();

  _modalForm.default.init();
});

},{"../libs/modules/burger-menu.js":93,"../libs/modules/modal-form.js":94,"../libs/modules/reveal-ajax":95,"../libs/modules/slider-partners.js":96,"../libs/modules/slider.js":97,"gsap":2}]},{},[98]);
